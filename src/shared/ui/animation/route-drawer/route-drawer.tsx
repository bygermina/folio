...
import { SVGPathVisualization } from '@/shared/ui/debug/svg-path-visualization';
import { PathControls } from '@/shared/ui/debug/path-controls';
import { pointsToPath } from '@/shared/lib/svg';
